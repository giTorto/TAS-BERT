...
def create_test_data_loader(data_dir, tokenize_method, max_seq_length, tokenizer, ner_label_list, label_list, processor,
                            eval_batch_size):
    test_examples = processor.get_test_examples(data_dir)
    test_features, test_tokens = convert_examples_to_features(
        test_examples, label_list, max_seq_length, tokenizer, ner_label_list, tokenize_method)
    ...
    test_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_ner_label_ids,
                              all_ner_mask)
    test_dataloader = DataLoader(test_data, batch_size=eval_batch_size, shuffle=False)

    return test_dataloader, test_tokens
...
def main():
    ...
    train_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_ner_label_ids,
                               all_ner_mask)
